...
namespace DAL
{
    public class TraduccionDAL : ITraduccionDAL
    {
        ...
        public void InicializarBaseDatosSiVacio()
        {
            ...
            seed("PermisosForm.lblMiembros", "Miembros del Rol", "Role Members", "Membros del Grupo");
            seed("PermisosForm.btnGuardarRelaciones", "Guardar Relaciones del Rol", "Save Role Relationships", "Salvar Relações del Grupo");
            seed("PermisosForm.lblCol2ControlesTitulo", "Mapeo de Controles", "Control Mapping", "Mapeamento de Controles");
            seed("PermisosForm.lblFormulario", "Formulario:", "Form:", "Formulário:");
            seed("PermisosForm.lblControlesDisponibles", "Disponibles", "Available", "Disponíveis");
            seed("PermisosForm.lblControlesAsociados", "Asociados", "Associated", "Associados");
            seed("PermisosForm.btnGuardarControles", "Guardar Controles", "Save Controls", "Salvar Controles");
            ...
            seed("PermisosForm.lblPermisosPlanas", "Permisos Resultantes", "Resulting Permissions", "Permissões Resultantes");
